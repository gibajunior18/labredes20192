...
// | Bugs, traduções ou problemas, escreva para: igtoth@netsite.com.br    |
// |                                                                      |
...
// +----------------------------------------------------------------------+
	...
	$banco="sas";			 // NAO ALTERAR (somente se necessario)
					 // DONT CHANGE (only if necessary)
	$usuario="SEU_USUARIO_MYSQL";	 // USUARIO BD  - DB USER
	$senhadb="SUA_SENHA_MYSQL";	 // SENHA BD    - DB PASSWORD
	$servidor="SEU_SERVIDOR.COM.BR"; // IP SERVIDOR - SERVER IP
