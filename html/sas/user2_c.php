...
<script Language="JavaScript">
	...
	*/
	...
	<center><font face="verdana,arial" size="1" color="#4682B4">SAS 2 v.<?php include('versao.inc.php'); echo $versao; ?> www.ighor.com
...
if($enviar=="sim"){
	...
	if(($linha1["matsup"]==$matricula)&&($linha1["senha"]==$senha)){
		...
		// $de="Return-Path: <sas@intragol01.rpo.brasilcenter.com.br>\n";
		$de=$linha1["nome_sup"];
